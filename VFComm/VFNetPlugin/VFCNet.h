...
public:
    ...
    VFCNet(BaseType* pBaseType, void (BaseType::*handleRecieve)(const int, const int, const char*, const uint32_t), void (BaseType::*handleEvent)(const int, const VF_NET_EVENT, VFINet*))
    {
        base = NULL;
        listener = NULL;
...
protected:
    int DeCode(const char* strData, const uint32_t unLen, VFCMsgHead& xHead);
