...
#ifndef PROTOBUF_VFDefine_2eproto__INCLUDED
#define PROTOBUF_VFDefine_2eproto__INCLUDED
...
void LIBPROTOC_EXPORT protobuf_AddDesc_VFDefine_2eproto();
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::EGameEventCode>() {
  return ::VFMsg::EGameEventCode_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::ESynMsgID>() {
  return ::VFMsg::ESynMsgID_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::EGameMsgID>() {
  return ::VFMsg::EGameMsgID_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::EItemType>() {
  return ::VFMsg::EItemType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::EGameEquipSubType>() {
  return ::VFMsg::EGameEquipSubType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::EGameGemSubType>() {
  return ::VFMsg::EGameGemSubType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::EGameItemSubType>() {
  return ::VFMsg::EGameItemSubType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::EGameCardSubType>() {
  return ::VFMsg::EGameCardSubType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::EGameTokenSubType>() {
  return ::VFMsg::EGameTokenSubType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::EGameItemExpiredType>() {
  return ::VFMsg::EGameItemExpiredType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::EDrawDropItemState>() {
  return ::VFMsg::EDrawDropItemState_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::EGuildPowerType>() {
  return ::VFMsg::EGuildPowerType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::ETaskState>() {
  return ::VFMsg::ETaskState_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::ETaskType>() {
  return ::VFMsg::ETaskType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::EBattleType>() {
  return ::VFMsg::EBattleType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::EShopType>() {
  return ::VFMsg::EShopType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::ERankType>() {
  return ::VFMsg::ERankType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::ENPCType>() {
  return ::VFMsg::ENPCType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::EPropertyType>() {
  return ::VFMsg::EPropertyType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VFMsg::EGameElementType>() {
  return ::VFMsg::EGameElementType_descriptor();
}
...
#endif  // PROTOBUF_VFDefine_2eproto__INCLUDED
